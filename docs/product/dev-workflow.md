...
1. Clone the repo
2. Follow `docs/product/dev-setup.md` for Android SDK + emulator setup
...
5. **Document** — update `docs/product/prd.md` (the product contract), `baremobile.context.md`, testing guide
...
See `docs/product/dev-setup.md` for the full testing guide.
